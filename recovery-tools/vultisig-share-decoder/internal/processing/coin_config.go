...
// CoinConfig represents configuration for a supported ECDSA-based cryptocurrency (backward compatibility)
type CoinConfig struct {
        Name       string
        DerivePath string
}

// CoinConfigEdDSA represents configuration for a supported EdDSA-based cryptocurrency (backward compatibility)
